...
import 'package:pills/shopkepper/shoplogin/forger.dart';
import 'package:pills/shopkepper/shoplogin/singup.dart';final _formKey = GlobalKey<FormState>();


class ShopLoginPage extends StatelessWidget {
  ShopLoginPage({super.key});
                      ...
                      child: IconButton(
                          onPressed: () {
                            ...
                            if (_formKey.currentState!.validate()) {
                              Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>const ShopNavBare()));
                            }
                          },
                          icon: const Icon(
                    ...
                    Padding(
                      ...
                      child: InkWell(
                          onTap: () {
                            ...
                            Navigator.push(context, MaterialPageRoute(builder: (context)=>const ShopForgetPassword()));
                          },
                          child: const Text(
                            "forget Password",
                            style: TextStyle(
